...
class Registro extends ActiveRecord {
  ...
  public function __construct($args = []) {
    ...
    $this->regalo_id = $args['regalo_id'] ?? ''; // Se agrega 1 para que la validacion via controlador de Registro controller metodo conferencias reconozca el valor en la tabla
  }
}
